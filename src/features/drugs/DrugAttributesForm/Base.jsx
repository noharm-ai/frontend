...
function BaseForm({ data }) {
  ...
  return (
    <>
      <Divider titlePlacement="start" style={{ marginTop: "20px" }}>
        Classificação
      </Divider>
      <div
        style={{
      ...
      >
        <div className="form-row form-row-flex">
          <div
            className={`form-row ${errors.maxDose && touched.maxDose ? "error" : ""}`}
          >
            <div className="form-label">
              <label>
          ...
          <div
            className={`form-row ${errors.maxTime && touched.maxTime ? "error" : ""}`}
          >
            <div className="form-label">
        ...
        <div className="form-row form-row-flex">
          <div
            className={`form-row ${errors.platelets && touched.platelets ? "error" : ""}`}
          >
            <div className="form-label">
              <label>
                <Tooltip
          ...
          <div
            className={`form-row ${errors.fallRisk && touched.fallRisk ? "error" : ""}`}
          >
            <div className="form-label">
      ...
      >
        <div className="form-row form-row-flex">
          ...
          <div
            className={`form-row ${errors.amountUnit && touched.amountUnit ? "error" : ""}`}
          >
            <div className="form-label">
              <label>
                <Tooltip
