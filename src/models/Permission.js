export default class Permission {
  ...
  /** @deprecated split into READ_CONFIG_EXAMS/WRITE_CONFIG_EXAMS; kept as fallback for one release */
  ...
  static READ_CONFIG_EXAMS = "READ_CONFIG_EXAMS";
  static WRITE_CONFIG_EXAMS = "WRITE_CONFIG_EXAMS";
  ...
  static GENERATE_RESET_PASSWORD_LINK = "GENERATE_RESET_PASSWORD_LINK";
  static READ_RESET_PASSWORD_HISTORY = "READ_RESET_PASSWORD_HISTORY";
  ...
  static READ_CUSTOM_REPORTS = "READ_CUSTOM_REPORTS";
  static WRITE_CUSTOM_REPORTS = "WRITE_CUSTOM_REPORTS";
  static WRITE_CUSTOM_REPORTS_GRAPHS = "WRITE_CUSTOM_REPORTS_GRAPHS";
  ...
  static READ_TAGS = "READ_TAGS";
  static WRITE_TAGS = "WRITE_TAGS";
  static WRITE_PATIENT_TAGS = "WRITE_PATIENT_TAGS";
